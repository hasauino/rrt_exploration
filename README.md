...
All robot's frame should be prefixed by its name. Namimg of robots starts from "/robot_1", "/robot_2", "/robot_3", .. and so on. Even if you are using the package for single robot, the robot frames should be prefixed by it name (i.e. /robot_1).
## 4. Nodes
